...
export const metadata: Metadata = { title: "Copecart-Import — Buchhaltung" };
    ...
    <div className="mx-auto max-w-6xl px-6 py-8 space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Transaktionsexport aus Copecart hochladen und gegen bestehende Deals abgleichen
        </p>
      </div>
      <ImportNav active="zahlungsabgleich" />
      <PlatformImportWizard platform="copecart" />
    </div>
  );
}
